...
%    1 - результаты
    ...
    \begin{frame}{Результаты}
        ...
        \begin{enumerate}
            ...
            \item Поддержка Self-типов реализована\footnote{\url{https://github.com/winter-yuki/kotlin/tree/self-types}} в компиляторе K2 за счет добавления специального вида типов и скоупа подстановки Self-типов
