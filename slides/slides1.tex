...
\usepackage{minted}
\setminted{xleftmargin=\parindent, linenos, autogobble, escapeinside=\#\#}
...
%    6 - основная часть
%       * 2 - анализ решений в других языках
%       * 2 - интеграция в типовую систему
    ...
    \begin{frame}[fragile]{Self-типы в других языках}
        ...
        \begin{block}{Python, TypeScript, Java Manifold}
            \begin{itemize}
                ...
                \item Только специальный параметр методов \mintinline{kotlin}|this| (\mintinline{python}|self|) имеет Self-тип
            \end{itemize}
        \end{block}
