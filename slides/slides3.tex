...
\begin{document}
    ...
    \begin{frame}{Системы типов}
        \note{
            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    \item но в то же время отвергает много корректных, чтобы оставаться разрешимым
                \end{enumerate}
    ...
    \begin{frame}[fragile]{Ограничение текущей системы типов Kotlin}
        \note{
            ...
            \begin{enumerate}
                \item На данный момент в системе типов Kotlin нет прямого способа написать тип получателя
                \begin{enumerate}
                ...
                \begin{enumerate}
                    ...
                    \item Поэтому вызов add на наследнике возвращает базовый тип
                    \item Что приводит к ошибке типизации несмотря на корректность кода
                \end{enumerate}
            \end{enumerate}
        }
        ...
        \note{
            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    ...
                    \item и этот код уже проходит проверку типов
                \end{enumerate}
            \end{enumerate}
        }
        ...
        \note{
            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    ...
                    \item Что может приветсти к ошибке времени исполнения
                \end{enumerate}
                \item Однако можно заметить, что Self-тип аналогичен параметру рекурсивного типа
                \item Чтобы воспользоваться его значением, нужно применить правило развёртки
    ...
    \begin{frame}[fragile]{Значения Self-типа: существующие решения}
        \note{
            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    \item Которые затрудняют дальнейшее развитие языка --- эти методы придётся специальным образом учитывать
                    \item А также их непросто использовать из-за множества сопутствующих нетривиальных правил
                \end{enumerate}
                \item Поэтому в прикладных языках не поддерживается типизация посторонних объектов Self-типов
...
%                        \item[$+$] Локальное изменение в языке
    ...
    \begin{frame}[fragile]{Контравариантные позиции Self-типа: решение для Kotlin}
        \note{
            ...
            \begin{enumerate}
                \item Я заметил, что для поддержания сложных методов для них запрещают виртуальную диспетчеризацию
