    ...
    \begin{frame}[fragile]{Решения в других языках}
        ...
        \begin{block}{Ассоциированные типы}
            \begin{itemize}
                ...
                \item Self-типы можно реализовать как частный случай ассоциированных
            ...
            \begin{column}[t]{0.53\textwidth}
                ...
                \begin{block}{Origin Self-типа}
                    ...
                    \begin{itemize}
                        ...
                        \item Для \mintinline[escapeinside=??]{kotlin}|?\framebox{Self}?| origin'ом является \mintinline{kotlin}|Base| (обозначение \underline{\mintinline{kotlin}|Self(Base)|})
...
fun test(a: A, b: B) {
    ...
    \begin{frame}[fragile]{Правила подтипизации}
        \begin{block}{Правила подтипизации}
            ...
            \begin{enumerate}
                \item \label{itm:covariant-origin} \mintinline{kotlin}|B <: A| $\iff$ \texttt{Self(B) <: Self(A)}
                \begin{itemize}
        ...
        \begin{block}{Безопасность присваиваний}
            \begin{enumerate}
                ...
                \item Правило (\ref{itm:this-subtype}) сохраняет обратную совместимость: \mintinline{kotlin}|val a: A = this|
            ...
            \begin{column}[t]{0.46\textwidth}
                \begin{block}{Ограничения}
                    \begin{itemize}
                        ...
                        \item Тип \mintinline{kotlin}|this|\footnote{Ресивер текущей декларации (c типом origin'а Self-типа)} либо равен \texttt{С}, либо включает \texttt{C} после smart-cast
...
abstract class A {
    ...
    \begin{frame}{Результаты}
        \begin{enumerate}
            ...
            \end{enumerate}
            \item Поддержка Self-типов реализована\footnote{\url{https://github.com/winter-yuki/kotlin/tree/self-types}} в компиляторе K2 за счет TODO % TODO добавления неявного типового параметра с рекурсивным ограничением
